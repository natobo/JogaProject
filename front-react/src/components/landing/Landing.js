                    ...
                    <div className="row">
                      <div className="col-md-6">
                        ...
                        <p className="text-center">
                          ...
                          una plataforma y múltiples preferencias relacionadas
                          con el juego.
                        </p>
                      </div>
                      <div className="col-md-6">
                  ...
                  <div className="container">
                    <div className="row">
                      <div className="col-md-6">
                        ...
                        <p className="text-center">
                          Ve a todos tus amigos y sus estados en línea. Mira
                          quién está pasando el rato y únete a su fiesta... ¡o
                ...
                >
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      ...
                      <p className="text-center">
                        Crea una fiesta para reunir a todos tus amigos en un
                        chat de voz y comunicarte mientras juegas. Selecciona un
                        juego, invita a tus amigos e incluso bloquea la fiesta.
                        O deja tu fiesta desbloqueada para que más amigos puedan
                        unirse rápidamente.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6">
                    <p className="text-center">
                      ...
                      <p className="text-center joga-text">
                        ¡Hola!, este es un proyecto que busca facilitar la
                        manera en que los gamers buscan compañeros de partida
                        para un juego en específico, por medio de salas comunes
                        llamadas LFG (looking for group) 👾 buscamos ser los
                        primeros en implementar este tipo de ideas aquí en
                        LATAM.
                      </p>
                    </p>
                  </div>
              ...
              <form className="contact-form" onSubmit={handleSubmitSignUp}>
                ...
                <div className="form-group">
                  <input
                    ...
                    name="username"
                    className="form-control"
                    placeholder="un gamertag o nombre de perfil"
                    autoComplete="off"
                    value={username}
                    onChange={handleInputChange}
                  />
                ...
                <div className="form-group">
                  <input
                    ...
                    name="avatarUrl"
                    className="form-control"
                    placeholder="Ingresa un link a tu img de perfil"
                    value={avatarUrl}
                    onChange={handleInputChange}
                  />
                </div>
