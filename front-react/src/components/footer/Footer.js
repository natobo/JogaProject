    ...
    <div className="footer-sm">
      <div className="container">
        <div className="row py-4 text-center text-white">
          <div className="col-lg-5 col-md-6 mb-4 mb-md-0">Bogotá Colombia</div>
          <div className="col-lg-7 col-md-6">
            ...
            <a href="https://github.com/isis3710-uniandes/202120_S2_E1">
        ...
        <div className="row text-center text-white">
          <div className="col-12">
            <div className="footer-bottom__copyright">
              <span className="copyright">&copy;</span> Copyright 2021{' '}
              <a href="#">Company</a> | Created by{' '}
              <a
                href="https://github.com/isis3710-uniandes/202120_S2_E1"
                target="_blank"
                rel="noreferrer"
              >
                Joga Team
